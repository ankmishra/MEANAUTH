...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ngx_flash_messages__ = __webpack_require__("../../../../ngx-flash-messages/lib-dist/flash-messages.module.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'dashbord', component: __WEBPACK_IMPORTED_MODULE_10__component_dashbord_dashbord_component__["a" /* DashbordComponent */] },
...
module.exports = "<div class=\"jumbotron\">\n      <div class=\"container\">\n        <h1>Mean Auth</h1>\n        <p>This is a template for a simple marketing or informational website. It includes a large callout called a jumbotron and three supporting pieces of content. Use it as a starting point to create something more unique.</p>\n          <p><a class=\"btn btn-primary btn-lg\" [routerLink]=\"['/register']\" role=\"button\">Register &raquo;</a>\n            <a class=\"btn btn-primary btn-lg\" [routerLink]=\"['/login']\" role=\"button\">Login&raquo;</a></p>\n      </div>\n    </div>\n"
...
module.exports = "<h1>Login Form</h1>\n<form (submit)=\"onLoginSubmit()\">\n <div class=\"form-group\">\n   <label for=\"email\">username</label>\n   <input type=\"text\" [(ngModel)]=\"username\" name = \"username\" class=\"form-control\" id=\"uname\">\n </div>\n <div class=\"form-group\">\n   <label for=\"email\">password</label>\n   <input type=\"text\" [(ngModel)]=\"password\" name = \"password\" class=\"form-control\" id=\"pass\">\n </div>\n <button type=\"submit\" class=\"btn btn-default\">Login</button>\n</form>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authservice.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('you are now logged in', { classes: ['alert-success'], timeout: 3000 });
                _this.router.navigate(['/dashbord']);
            }
            else {
                console.log(data);
                _this.flashMessage.show('somthing wrong', { classes: ['alert-danger'], timeout: 3000 });
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_ngx_flash_messages__["b" /* FlashMessagesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ngx_flash_messages__["b" /* FlashMessagesService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */]) === "function" && _c || Object])
], LoginComponent);
...
module.exports = "<nav class=\"navbar navbar-default\">\n <div class=\"container-fluid\">\n   <div class=\"navbar-header\">\n     <a class=\"navbar-brand\" [routerLink]=\"['/']\">AuthMean</a>\n   </div>\n\n   <ul class=\"nav navbar-nav navbar-right\">\n     <li><a [routerLink]=\"['/register']\"><span class=\"glyphicon glyphicon-user\"></span> Sign Up</a></li>\n     <li><a [routerLink]=\"['/login']\"><span class=\"glyphicon glyphicon-log-in\"></span> Login</a></li>\n     <li><a (onclick) =\"onLogoutClick()\" href =\"#\"><span class=\"glyphicon glyphicon-log-in\"></span> Logout</a></li>\n\n   </ul>\n </div>\n</nav>\n"
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessage.show('you are now logged out', { classes: ['alert-success'], timeout: 3000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            this.flashMessage.show('please fill all fields', { classes: ['alert-danger'], timeout: 3000 });
            return false;
        }
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('please fill email correctly', { classes: ['alert-danger'], timeout: 3000 });
            return false;
        }
        this.authservice.registerUser(user).subscribe(function (data) {
            if (data.sucess) {
                _this.flashMessage.show('you are registered', { classes: ['alert-success'], timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('somthing wrong', { classes: ['alert-danger'], timeout: 3000 });
...
RegisterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4_ngx_flash_messages__["b" /* FlashMessagesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ngx_flash_messages__["b" /* FlashMessagesService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === "function" && _d || Object])
], RegisterComponent);
